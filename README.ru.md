...
| 6 | Включаете/выключаете **AI-комментарии** (чекбокс). Настраиваете частоту, роль комментатора, **и выбираете TTS движок** (Edge TTS, Piper, Supertonic 3 или Silero TTS v5) |
...
| Язык | Основной голос (текст) | Голос комментатора |
|------|----------------------|-------------------|
| 🇷🇺 Русский | **xenia** (женский) | **eugene** (мужской) |
| 🇬🇧 Английский | **lj_16khz** (женский) | **random** (мужской) |
...
Можно изменить: язык интерфейса, язык книги, AI-провайдер, TTS движок (edge/piper/supertonic/silero), голоса TTS и скорость, длительность пауз, частоту комментариев, включение/отключение комментариев, папку вывода.
