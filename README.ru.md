...
Можно изменить: язык интерфейса, язык книги, AI-провайдер, TTS движок (edge/piper/supertonic/silero), пол голосов (main_gender, comment_gender), скорость, длительность пауз, частоту комментариев, включение/отключение комментариев, папку вывода.
